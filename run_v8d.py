...
"""v8d — エントリポイント。
  ...
  python run_v8d.py --config configs/config_field_v8d.yaml --provider mock
  python run_v8d.py --config configs/config_field_v8d.yaml --steps 1     # 実APIスモーク
  python run_v8d.py --config configs/config_field_v8d.yaml --workers 4   # 本走（36か月）

既存の `run.py`・`run_v8.py`・`run_v8b.py`・`run_v8c.py` には触らない。
...
from src.sim_v8d import SimulationV8D                    # noqa: E402


def main() -> int:
    ap = argparse.ArgumentParser()
    ap.add_argument("--config", default="configs/config_field_v8d.yaml")
