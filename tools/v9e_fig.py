#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""v9e の曲線図（決定論・API 不使用）。v9 単独と同じ形で、前の版は重ねない。

  python tools/v9e_fig.py --run simulations/<v9e_run> \
      --out docs/submission/fig_v9e_curve.png
...
def main() -> int:
    ...
    ap.add_argument("--out", default="docs/submission/fig_v9e_curve.png")
    args = ap.parse_args()
