...
LINES = {
    "01": "外的不動産買収へのコミュニティ自衛。コミュニティの創発は、外的な不動産買収を抑制できるのか、検証しました。",
    "02": "ニセコや対馬では、実際に不動産を買われてから町は知りました。安全保障上の危機事例です。",
    "03": "海外の不動産投資会社X社が、地方都市A市の不動産の過半買収を試みるシミュレーションです。",
    "04": "X社が、不動産所有者に買収を提案します。町の人は迷い、相談し、売るか売らないかを決めます。これを36か月・3年間シミュレーションしました。",
    "05": "緑と黄色は、スタート時点の土地建物所有状況です。赤に変わったところが、X社のものになった不動産です。",
    "08": "小声で、静かに、深刻な調子で読んでください：あなたの町は、大丈夫？",
}
